...
namespace mainApp
{
    ...
    void RecipeElementWidget::getElementListData(std::vector<nutrientContentTable>& contentTable, float& eachPer)
    {
        m_pUi->m_pElementWidget->getElementListData(contentTable, eachPer);
    }
